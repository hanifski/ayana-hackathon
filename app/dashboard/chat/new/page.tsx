...
export default function page() {
  ...
  //   model: "gpt-3.5-turbo",
  //   instructions: "Provide assistance with OpenAI related queries.",
  //   temperature: 0.7,
  //   files: [],
  // };
  ...
  const handleSubmit = async (data: z.infer<typeof createAssistantSchema>) => {
    ...
    create(assistant.id, assistant.name, assistant.model);
  };
                      ...
                      >
                        ...
                        <div className="flex flex-col items-center gap-2 text-center">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Supported formats: PDF, TXT, MD, JSON (Max 20MB)
                          </p>
                        </div>
                      </div>
                    </FormControl>
