...
ALTER TYPE "public"."workspace_member_status" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."members" (
    ...
    "role" "public"."workspace_roles" DEFAULT 'member'::"public"."workspace_roles" NOT NULL,
    "workspace_id" "uuid" NOT NULL,
    "status" "public"."workspace_member_status" DEFAULT 'pending'::"public"."workspace_member_status" NOT NULL,
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL
);
...
ALTER TABLE ONLY "public"."members"
    ADD CONSTRAINT "members_pkey" PRIMARY KEY ("user_id", "id");



ALTER TABLE ONLY "public"."profiles"
    ADD CONSTRAINT "profile_mobile_phone_key" UNIQUE ("mobile_phone");
...
ALTER TABLE ONLY "public"."workspaces"
    ADD CONSTRAINT "workspaces_workspace_id_key" UNIQUE ("id");
...
ALTER TABLE ONLY "public"."assistants"
    ADD CONSTRAINT "assistants_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."profiles"
    ADD CONSTRAINT "profile_active_workspace_fkey" FOREIGN KEY ("active_workspace") REFERENCES "public"."workspaces"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."members"
    ADD CONSTRAINT "workspace_member_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."members"
    ADD CONSTRAINT "workspace_member_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."workspaces"
    ADD CONSTRAINT "workspace_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
CREATE POLICY "Enable read access for authenticated users only" ON "public"."members" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Enable read access for authenticated users only" ON "public"."workspaces" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Enable ypdate for users based on user_id" ON "public"."profiles" FOR UPDATE USING (("user_id" = "auth"."uid"()));
